...
{
    public partial class fr_Calam : Form
    {
        public fr_Calam()
        {
            InitializeComponent();
        }
        E_tb_Calam thucthi = new E_tb_Calam();
        ConnectDB cn = new ConnectDB();
        EC_tb_Calam ck = new EC_tb_Calam();
        bool themmoi;
        int dong = 0;
        ...
        public void locktext() // phương thức khóa và mở khóa các textbox tùy vào tình trạng truyền vào 
        {
            txtma.Enabled = false;
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[0].HeaderText = "Mã Ca Làm";
            msds.Columns[0].Frozen = true;
            msds.Columns[0].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            msds.Columns[0].Width = 150;
            msds.Columns[1].HeaderText = "Tên Ca Làm";
            msds.Columns[1].Width = 320;

        }
        public void hienthi()
        {
            string sql = "SELECT maca, tenca FROM tb_Calam";
