...
namespace QuanLyBanHangDienTu.Presentation
{
    public partial class fr_BC_NV : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "E Store";
            ...
            sql = @"SELECT tb_HDB.manv, sum(tb_CTHDB.soluong) AS T FROM tb_HDB INNER JOIN tb_CTHDB ON tb_HDB.sohdb = tb_CTHDB.sohdb where tb_HDB.manv='"+cbnv.Text+"' group by tb_HDB.manv order by sum(tb_CTHDB.soluong) ASC";
              gtblThongtinHang = cn.taobang(sql);
            //Tạo dòng tiêu đề bảng
            exRange.Range["A11:F11"].Font.Bold = true;
            exRange.Range["A11:F11"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["C11:F11"].ColumnWidth = 12;
            exRange.Range["A11:A11"].Value = "STT";
            exRange.Range["B11:B11"].Value = "Mã NV";
        ...
        public DataTable gtblThongtinHang { get; set; }
    }
}
